angular.module('portfolioApp').controller('ExpirenceController', function($scope, $routeParams) {
  ...
  $scope.projects = [{
    name: 'H&H',
    url: '#hh/0',
    front-cover: '/assets/H&HCover.PNG',
  ...
  },
  {
    name: 'NexJ',
    url: '#nexj/1',
    front-cover: 'http://health.blog.yorku.ca/files/2012/12/cwp-participant-1.jpg',
  ...
  },
  {
    name: 'Amazon',
    url: '#amazon/3',
    front-cover: 'http://www.channeladvisor.com/caapi/wp-content/uploads/2015/07/Amazon.png',
  ...
  },
  {
    name: 'Interaxon',
    url: '#interaxon/4',
    front-cover: 'http://betakit.com/wp-content/uploads/2014/06/Screen-Shot-2014-06-04-at-12.13.08-PM-1050x564.png',
